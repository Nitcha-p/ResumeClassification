...
# Load the dataset (Replace 'resume_data.xlsx' with your actual file)
...
'''Slide 8 : Split Data for Training and Testing'''
# Split dataset (80% training, 20% testing)
X_train, X_test, y_train, y_test = train_test_split(X_selected, y, test_size=0.2, random_state=42)

'''Slide 8 : Use Grid Search for Hyperparameter Tuning'''
...
# Perform Grid Search
grid_search = GridSearchCV(LinearSVC(class_weight='balanced'), param_grid, cv=5, scoring='accuracy', verbose=2, n_jobs=-1)
